...
Este projeto tem como objetivo implementar progressivamente e de forma didática uma aplicação web inspirada em sites de estatisticas de Counter Strike.
...
- **APIs**
- Liquipedia - A melhor e mais atualizada API para adiquirir informações sobre partidas profissionais de e-sports
- **JavaScript:**
